...
const DEFAULT_ROLE_PERMS={viewer:{addSlot:false,editSlot:false,deleteSlot:false,editVerified:false,verifySlot:false,bulkVerify:false,useAiImport:false,useInsights:false,useVerifica:false,editAnagrafica:false,viewLog:false,viewBackup:false,editSettings:false,manageDemo:false},user:{addSlot:true,editSlot:true,deleteSlot:true,editVerified:false,verifySlot:false,bulkVerify:false,useAiImport:true,useInsights:true,useVerifica:true,editAnagrafica:true,viewLog:true,viewBackup:true,editSettings:false,manageDemo:false},admin:{addSlot:true,editSlot:true,deleteSlot:true,editVerified:true,verifySlot:true,bulkVerify:false,useAiImport:true,useInsights:true,useVerifica:true,editAnagrafica:true,viewLog:true,viewBackup:true,editSettings:true,manageDemo:true}};
const ALL_PERMS={addSlot:true,editSlot:true,deleteSlot:true,editVerified:true,verifySlot:true,bulkVerify:true,useAiImport:true,useInsights:true,useVerifica:true,editAnagrafica:true,viewLog:true,viewBackup:true,editSettings:true,manageDemo:true};
