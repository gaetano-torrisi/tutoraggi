...
function AiPanel({tutors,anagraficaAv,settings,user,isSuperAdmin,onAddTut,onAddAv,onSaveTutor,onSaveAna,onOpenAnaTutors,onOpenAnaAvvisi,onClose}){
  ...
  const PHRASES=["Cosa importiamo oggi? 🚀","Quale documento analizziamo? 📄","Pronti per l'import!","Carica il file, penso a tutto io. ✨","Un documento alla volta, un passo alla volta. 📋","Dimmi tutto, estraggo io le date. 🗓️","Analisi in corso... attendo il tuo file.","Trasformo documenti in appuntamenti. 🤖","Nessun dato va perso con me. 💾","PDF, immagini, testo — leggo tutto. 📑","Ogni data al suo posto nel calendario. 📅","Veloce, preciso, sempre pronto.","Manda il documento, ci penso io.","Ore di lavoro in pochi secondi. ⚡","Il tuo assistente AI per il tutoraggi. 🎓","Carica e aspetta — faccio il resto.","Analizzo, estraggo, importo. Tutto automatico.","Documenti complessi? Nessun problema. 💪","Il calendario cresce, io leggo i documenti.","Pronto ad analizzare il prossimo file. 🔍","Estraggo le date meglio di chiunque altro. 📌","Scannerizza, carica, importa. Semplicissimo.","I tuoi dati, organizzati in un clic. ✅","Ogni sessione nel posto giusto. 🎯","Anche le tabelle le capisco. 📊","Qualsiasi formato, nessun problema.","La magia dell'AI al servizio dei tutoraggi.","Importa in massa con un solo file. 🗂️","Preciso al minuto, veloce al secondo. ⏱️","Ti aiuto a non perdere nemmeno una sessione. 🌟"];
