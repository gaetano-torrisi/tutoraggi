...
function App({user}){
  ...
  return(<div className="app-shell">
    ...
    {showInsights&&perms.useInsights&&<InsightsScreen corsi={corsi} anagraficaCorsi={anagraficaCorsi} tutors={tutors} tutEvents={tutEvents} currentMonthKey={month.key} onClose={()=>setShowInsights(false)} onNavigate={(mk)=>{setShowInsights(false);const idx=MONTHS.findIndex(m=>m.key===mk);if(idx>=0){setMonthIdx(idx);setActiveScreen("calendar");}}}/>}
